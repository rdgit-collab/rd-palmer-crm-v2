-- Restore the sales_person field returned by the quotation/invoice list RPCs.
-- The Manage Quotations and Manage Invoices tables render this JSON property in
-- their Sales column.
...
as $$
  ...
  row_json as (
    select coalesce(jsonb_agg(jsonb_build_object(
      ...
      'sales_person', page_rows.sales_person,

    ...
    <div className="p-6 max-w-5xl">
      ...
      <form onSubmit={handleSave} className="bg-white border border-gray-200 p-6 space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Conducted By <span className="text-red-500">*</span></label>
            <select value={form.conduct_by} onChange={e => setForm(f => ({...f, conduct_by: e.target.value}))} required className="w-full border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-red-400">
              <option value="">Please Select</option>
